...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/bitcoal"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutBitCoalAction = new QAction(MainWindow);
        m_aboutBitCoalAction->setObjectName(QStringLiteral("m_aboutBitCoalAction"));
        m_aboutBitCoalAction->setEnabled(true);
        ...
        menuHelp->addAction(m_aboutBitCoalAction);
        ...
        QObject::connect(m_aboutBitCoalAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
...
#endif // QT_NO_TOOLTIP
        m_aboutBitCoalAction->setText(QApplication::translate("MainWindow", "About BitCoal", 0));
        ...
        m_sendButton->setText(QApplication::translate("MainWindow", "SEND BITCOAL", 0));
